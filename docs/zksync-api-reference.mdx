...
You can optionally control the output by setting the number of transactions displayed per page with  the `offset` param, sort the transactions by ascending and descending order (`asc` and `desc` parameters) and decide what page should be displayed with the `page` param. 
...
| 404 Not Found             | Transaction(s) not found.                                              |
